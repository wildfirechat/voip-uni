...
<script>
import CreateConferenceView from "./CreateConferenceView.vue";
import JoinConferenceView from "./JoinConferenceView.vue";
import OrderConferenceView from "./OrderConferenceView.vue";
